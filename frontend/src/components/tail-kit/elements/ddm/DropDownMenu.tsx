import { HideOnClickOutside } from '@components/tail-kit/misc/HideOnClickOutside'
...
export const DropDownMenu: FC<Props> = (props: Props) => {
  ...
  return (
    <div className="relative inline-block text-left">
      ...
      >
        <div className="origin-top-right absolute right-0 w-36 z-30 rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5">
          <div
            className={`py-1 ${
