...
export const SimpleProfile: FC<Props> = (props: Props) => {
  return (
    <div
      className={`${
        props.noBackground
          ? ``
          : `shadow-lg rounded-2xl bg-white dark:bg-gray-800 `
      }p-4`}
    >
      <div
        className={`${
          props.horizontal ? `flex-row gap-4` : `flex-col `
      ...
      >
        ...
        <div
          className={`${
            props.horizontal ? `` : `mt-2 text-center`
          } flex flex-col`}
        >
